...
public:
    ...
    BasicCamera(float eyeX = 0.0, float eyeY = 1.0, float eyeZ = 3.0, float lookAtX = 0.0, float lookAtY = 0.0, float lookAtZ = 0.0, glm::vec3 viewUpVector = glm::vec3(0.0f, 1.0f, 0.0f)) : eye(glm::vec3(eyeX, eyeY, eyeZ)), lookAt(glm::vec3(lookAtX, lookAtY, lookAtZ)), V(viewUpVector), u(glm::vec3(0.0f)), v(glm::vec3(0.0f)), n(glm::vec3(0.0f))
    {
